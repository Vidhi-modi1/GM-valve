...
export function SemiQcPage({ searchTerm = '', onSearchChange, onNavigateToOrders, showAddOrderModal = false, setShowAddOrderModal }: OrdersPageProps) {
  ...
  // Quick assign state
  const [quickAssignStep, setQuickAssignStep] = useState('after-phosphating');
    ...
    <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in bg-white min-h-screen">
      <div className="mb-8">
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-6">
          <div>
            <h1 className="text-gray-900 mb-2">Semi QC</h1>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={quickAssignStep} onValueChange={setQuickAssignStep} disabled>
                    <SelectTrigger id="assignStep" className="font-bold">
                      <SelectValue placeholder="After Phosphating QC" />
                    </SelectTrigger>
                    <SelectContent>
