...
export function LoginForm({ onLogin }: LoginFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onLogin(); // ✅ notify App.tsx to show dashboard
    ...
    <div className="flex flex-col space-y-6 w-full">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button
          type="submit"
          disabled={loading}
          className="w-full h-12 rounded-3xl bg-gradient-to-r from-[#2461c7] to-[#174a9f] hover:from-[#174a9f] hover:to-[#123a7f] text-white border-0 shadow-lg hover:shadow-2xl transition-all duration-300"
        >
