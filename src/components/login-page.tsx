  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-8 py-12 background-accent-blue relative overflow-hidden">
        ...
        <div
          className="background-glow-bottom animate-pulse-soft"
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-40 h-40 bg-indigo-400/10 rounded-full blur-3xl animate-float"
