...
export function MarkingPage({ searchTerm = '', onSearchChange, onNavigateToOrders, showAddOrderModal = false, setShowAddOrderModal }: MarkingPageProps) {
  ...
  const handlePrint = () => {
    try {
      ...
      import('jspdf').then(({ default: jsPDF }) => {
        ...
        pdf.text('Marking - 1 Report', 20, 20);
        ...
        // Save the PDF
        const fileName = `Marking-1_Report_${new Date().toISOString().split('T')[0]}.pdf`;
        pdf.save(fileName);
      });
    ...
    <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in bg-white min-h-screen">
      <div className="mb-8">
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-6">
          <div>
            <h1 className="text-gray-900 mb-2">Marking - 1</h1>
