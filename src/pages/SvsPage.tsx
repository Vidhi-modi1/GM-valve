...
console.log(
  ...
  const handleQuickAssign = (order: AssemblyOrderData) => {
    ...
    const nextStep =
    order.assemblyLine?.toLowerCase() === "d"
      ? "marking2"
      : "marking1";
        setQuickAssignStep(nextStep);
...
>
  ...
  setSearchTerm={setLocalSearchTerm}
      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
        <div ref={tableScrollRef} className="relative overflow-x-auto max-w-full"  style={{
          ...
          <div className="inline-block min-w-full align-middle">
            ...
            <table className="min-w-full border-collapse">
                ...
                <tr>
                  ...
                  <th className="sticky left-164 z-20 bg-white px-3 py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200 min-w-28">SOA NO.</th>
                 <th
...
>
 Sr.No.
  ...
  <div className="border-t bg-gray-50 px-6 py-3 flex flex-wrap gap-6 justify-end text-sm font-semibold">
    ...
    <SelectItem value="marking2">Marking 2</SelectItem>
  </SelectContent>
                  </Select>
                </div>
                  ...
                  <div className="py-6 space-y-8">
                    {selectedOrdersData.map((order) => (
                      ...
                      >
                        ...
                        {/* SPECIAL NOTE */}
                        <div className="mt-4 text-sm flex gap-2 items-center">
                          <span className="font-semibold inline-block">Special Note:</span>
