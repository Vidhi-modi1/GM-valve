...
export function Marking1Page() {
  ...
  const handleQuickAssign = (order: AssemblyOrderData) => {
    const currentStep = "marking1"; // 👈 set dynamically based on page
    const nextSteps = getNextSteps(currentStep);
  ...
  //     const currentStep = selectedOrder?.currentStep || selectedOrder?.stage || "Marking1";
